...
async def process_batch_item(manufacturer: str, product_name: str, url: str):
    ...
    if "error" in scraped_data:
        return {"status": "error", "reason": scraped_data["error"], "product": product_name}
    ...
    # 6. Preparazione Dati (NESSUN INSERT NEL DB QUI!)
    ...
    # Restituiamo il dizionario dati al Controller
    return {
